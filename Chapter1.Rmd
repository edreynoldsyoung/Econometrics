...
# C1 <span class="a">Use the data in WAGE1.RAW for this exercise.</span> 
...
# C3 The data in MEAP01.RAW are for the state of Michigan in the year 2001.  Use these data to answer the following questions.
...
# C4 The data in JRTAIN2.RAW come from a job training experiment conducted for low-income men during the 1976-1977; lee Lalond (1986)
...
# C5 The data in FERTIL2.DTA were collected on women living in the Republic of Botswana in 1988.  The variable *children* refers to the number of living children.  The varialbe *electric* is a binary indicator equal to one if the woman's home has electricity, and zero if not.
...
The average number of children born to women without electricity is `r mean(fertil2$children[fertil2$electric == 0], na.rm = TRUE)`

The average number of children born to women with electricity is `r mean(fertil2$children[fertil2$electric == 1], na.rm = TRUE)`
